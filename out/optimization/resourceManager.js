...
exports.IntelligentResourceManager = void 0;
/**
...
class ResourceOptimizer {
    async calculate(params) {
        ...
        const optimal = await this.findOptimalAllocation(predictions, current, constraints);
    ...
    async findOptimalAllocation(predictions, current, constraints) {
    ...
    validateConstraints(allocation, constraints) {
    ...
    calculatePerformanceScore(allocation) {
...
class IntelligentResourceManager {
    ...
    async applyOptimizations(optimal) {
        if (!this.currentAllocation) {
            throw new Error('Resource manager not initialized');
        }
...
exports.IntelligentResourceManager = IntelligentResourceManager;
